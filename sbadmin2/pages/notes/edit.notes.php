        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Edit Significant Notes</h1>
                    </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Edit Significant Notes</h6>
                                </div>
                                <div class="card-body">
                                        ...
                                        <div class="row mx-auto">
                                            ...
                                            <div class="col-md-4">
                                                <div class="my-3">
                                                    ...
                                                    required placeholder="Enter Incident" value="<?php echo $row['incident']; ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="my-3">
